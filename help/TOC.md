...
+ はじめに {#getting-started}
   ...
   + CRM コネクタ {#connectors}
      ...
      + {hide-from-toc}[Microsoft Dynamics 365とつながる](platform/using/crm-ms-dynamics.md)
...
+ インストールおよび設定ガイド {#installing-campaign-classic}
   ...
   + Campaign の設定 {#additional-configurations}
      ...
      + {hide-from-toc}[CampaignでのMX サーバーの使用](installation/using/using-mx-servers.md)
...
+ 移行ガイド {#migrating-to-a-new-version}
   + {hide-from-toc}[Adobe Campaign v7への移行](migration/using/about-migration.md)

...
この評価を使用することで、潜在的な異常値ギャップとその原因を特定できます。ギャップがキャンペーンのパフォーマンスの問題によるものか、Apple のプライバシー保護機能によるものかを判断できます。[ヒントとテクニック](#measure-ios-footprint)を参照してください。
...
1. クエリで始まるワークフローを作成します。
   ...
   最初のクエリは、過去 3 か月間のトラッキングログを取得するのに使用されます。

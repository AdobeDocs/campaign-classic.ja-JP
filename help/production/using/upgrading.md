...
>[!NOTE]
>
>インストールガイドとビルドア [ップグレードの概要](../../installation/using/general-architecture.md) (英語の [み](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/buildUpgrade.html) )も参照してください。

...
デフォルトでは、バウンスメールは [プラットフォームのデフォルトエラーボックス](../../installation/using/deploying-an-instance.md#parameters-for-delivered-emails-parameters-for-delivered-emails)配信の特定のエラーアドレスを定義できます。

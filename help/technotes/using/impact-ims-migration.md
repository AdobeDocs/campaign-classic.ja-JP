...
オペレーターの管理は Adobe Admin Console に一元化されて、次のタスクはこのコンソールを通じてのみ管理されるようになりました。 ユーザーを作成して権限を割り当てる方法については、[Campaign v8 ドキュメント &#x200B;](https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/admin/permissions/manage-permissions){target="_blank"}を参照してください。

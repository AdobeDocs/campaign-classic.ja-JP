...
* E メール配信でミラーページ URL が正しく定義されない問題を修正しました。（NEO-26084）
...
* ワークフローの計算済みフィールドに影響を与える不具合を修正しました。（NEO-25194）
* Web 追跡 URL のオンザフライ作成が機能しない問題を修正しました。（NEO-20999）
* PDF に書き出すと、そのまますぐに使用できる配信レポートが切り捨てられて表示される問題を修正しました。（NEO-25757）

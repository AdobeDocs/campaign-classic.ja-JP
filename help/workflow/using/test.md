...
<target xml:lang="en-XX">ワークフロー JavaScript 経由でアクセス可能なアプリケーションサーバーのその他すべての JavaScript 関数および SOAP メソッドの詳細については、<ph id="1" ctype="x-LINK">[</ph>JSAPI ドキュメント<ph id="2" ctype="x-LINK">[#$tu8]</ph>を参照してください。</target>
</trans-unit>

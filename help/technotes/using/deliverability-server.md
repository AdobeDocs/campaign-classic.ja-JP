...
>[!NOTE]
>
>これらの変更点について詳しくは、[FAQ](#faq)を参照するか、[Adobe カスタマーケア ](https://helpx.adobe.com/jp/enterprise/admin-guide.html/enterprise/using/support-for-experience-cloud.ug.html){_blank}にお問い合わせください。
>
...
1. **Adobe Campaign** をクリックし、組織を選択します。
   **注意**：複数の組織がある場合は、正しい組織を選択していることを確認します。 組織[の詳細については、このページ ](https://experienceleague.adobe.com/docs/control-panel/using/faq.html?lang=ja#ims-org-id){_blank}を参照してください。

...
* Campaign オンプレミス環境およびハイブリッド環境のお客様
  ...
  Adobe Console内の製品プロファイルについて詳しくは、[Adobe Developer Console ドキュメント &#x200B;](https://developer.adobe.com/developer-console/docs/guides/projects/){target="_blank"}を参照してください
...
詳しくは、[Adobe Developer Console認証ドキュメント &#x200B;](https://developer.adobe.com/developer-console/docs/guides/authentication/ServerToServerAuthentication/){target="_blank"}を参照してください。

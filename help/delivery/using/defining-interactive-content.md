...
1. **[!UICONTROL AMP サポート]**&#x200B;パッケージをインストールします。[Campaign 標準パッケージのインストール](../../installation/using/installing-campaign-standard-packages.md)を参照してください。
...
次のビデオでは、Adobe Campaign で AMP を有効にする方法を説明し、その使用方法を紹介します。

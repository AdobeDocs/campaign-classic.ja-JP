...
>
>IMSの実装は複雑なプロセスで、長くなる場合があります。 この作業をおこなうのはアドビの技術管理者に限られます。

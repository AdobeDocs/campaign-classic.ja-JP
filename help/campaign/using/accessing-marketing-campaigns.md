...
ナビゲーションバーのリンクをクリックして、様々な機能にアクセスします。

キャンペーン要素は&#x200B;**[!UICONTROL 「キャンペーン]**」タブにあります。ここでは、マーケティングプログラムとキャンペーン、およびサブセットの概要を確認できます。 マーケティングプログラムは複数のキャンペーンで構成され、キャンペーンは配信、タスク、リンクされたリソースなどで構成されます。キャンペーンを使用したマーケティングキャンペーン管理のコンテキストでは、配信、予算、レビュー担当者およびリンクされたドキュメントに関する情報がキャンペーンに含まれます。

**[!UICONTROL キャンペーン]**&#x200B;タブの&#x200B;**[!UICONTROL ブロック]**&#x200B;は、インスタンスにインストールされているモジュールに応じて、様々なオファーを指定します。 例えば、以下にアクセスできます。
...
各キャンペーンはプログラムに所属し、プログラムはプランに所属します。プラン、プログラム、キャンペーンは、「**キャンペーン**」タブの&#x200B;**[!UICONTROL キャンペーンカレンダー]**&#x200B;メニューを使用してアクセスします。

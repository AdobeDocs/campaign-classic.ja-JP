...
>[!NOTE]
>
>Adobe Campaign のキャンペーンの最適化とその使用方法について詳しくは、[Campaign v8 ドキュメント](https://experienceleague.adobe.com/ja/docs/campaign/automation/campaign-optimization/campaign-typologies){target=_blank}を参照してください。
...
>[!VIDEO](https://video.tv.adobe.com/v/27518?quality=12&captions=jpn)

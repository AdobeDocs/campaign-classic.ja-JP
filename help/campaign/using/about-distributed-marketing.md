...
product: campaign
title: キャンペーン分散マーケティング
description: 分散マーケティングの概要
audience: campaign
...
# 分散マーケティングの使い始めに{#about-distributed-marketing}
...
### 機能管理者タスク{#functional-administrator-side}
...
### ローカルオペレータータスク{#local-operator-side}

...
1. 「**[!UICONTROL プロジェクトの JSON ファイルを読み込んでプロジェクトの詳細を抽出…」をクリックします。]** をクリックして、JSON キーファイルを直接読み込みます。 JSON ファイルの抽出方法について詳しくは、[このページ](https://firebase.google.com/docs/admin/setup#initialize-sdk)を参照してください。

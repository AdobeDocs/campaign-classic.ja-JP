...
* **入力フィールドの追加**
  ...
  ページのコンテンツを作成するには、コンテンツを編集する必要があります。それには、**[!UICONTROL Page]** オブジェクトをダブルクリックします。 ツールバーの最初のアイコンをクリックして、フィールド作成アシスタントを開きます。 受信者のプロファイルの一致するフィールドに格納するユーザー名の入力フィールドを作成するには、「**[!UICONTROL 受信者を編集]**」を選択します。
...
* **[!UICONTROL 開始]** をクリックして公開を開始し、アシスタントを閉じます。

...
>[!NOTE]
>
>**[!UICONTROL 管理者]**&#x200B;権限を持つ他のすべての[!DNL Adobe Campaign] オペレーターもジョブを承認できますが、通知は受け取れません。\
...
通知コンテンツは、特定のテンプレート「**[!UICONTROL マーケティングキャンペーンの検証の通知]**」で定義されます。 このテンプレートは、[!DNL Adobe Campaign] ツリーの&#x200B;**[!UICONTROL 管理/ キャンペーン管理/ テクニカル配信テンプレート]** フォルダーに保存されます。

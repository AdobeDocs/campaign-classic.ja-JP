...
オンライン調査に対する回答を表示するためにレポートをデザインする方法については、[この使用例](../../reporting/using/use-case--displaying-report-on-answers-to-an-online-survey.md)を参照してください。

...
[セキュリティ](https://helpx.adobe.com/jp/campaign/kb/acc-security.html)、[配信品質](../../delivery/using/deliverability-key-points.md)および[プライバシー](../../platform/using/privacy-management.md)の入門ガイドが更新されました。

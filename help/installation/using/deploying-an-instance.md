...
* **[!UICONTROL 連絡を希望しない受信者を除外する]** :このオプションを選択すると、ブロックリスト上の受信者には接続されません。
...
* ブロックリスト:404エラーが返された場合、URLはブロックリストに追加されます。 ブロックリスト内のURLの長さ（秒）は、デフォルト値が60秒の **timeout** 属性で定義されます。

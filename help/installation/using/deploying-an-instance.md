...
>[!IMPORTANT]
>
>未処理のバウンス電子メールを転送する場合、アドビでは、エラーの **[!UICONTROL アドレス]** フィールドへの入力のみを推奨します。 ただし、使用するアドレスを定期的にチェックしていることを確認してください。これは、メールサーバに大きな負荷がかかる可能性があるためです。 詳しくは、アカウント担当者にお問い合わせください。
...
* サ **[!UICONTROL ーバ、ポート]**、 **[!UICONTROL アカウント]****[!UICONTROL 、パスワード、]**&#x200B;パスワード、パスワード、 **[!UICONTROL コネクタ、コネクタ、]**&#x200B;送信、受信、エンドポイント、エンドポイント、通知、エンドポイント、通知、エンドポイント、サーバ、ポート **************** 、アカウント、パスワード 必要な設定については、サービスプロバイダーにお問い合わせください。

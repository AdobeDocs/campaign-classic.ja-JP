...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> maxCnx<br /> </td> 
   <td> 新しい接続を拒否する前に許可される接続の最大数です。 この<a href="https://helpx.adobe.com/campaign/kb/how-to-increase-the-maximum-number-of-database-connections-from-.html"> テクニカルノート </a>を参照してください。<br /> </td> 
   <td> 短い<br /> </td> 
  </tr> 
  <tr> 

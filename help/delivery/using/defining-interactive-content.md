...
1. テストが完了すると、該当する E メールプロバイダーに登録して、送信者ドメインを許可リストに登録することで、AMP for Email ベータプログラムの一環として配信またはキャンペーンを送信できます。[E メールロバイダーへの登録と AMP E メールの配信](#delivering-amp-emails-by-registering)を参照してください。
...
動的な E メールの配信は、送信者ドメインを許可リストに登録するために、AMP ベータプログラムに参加する E メールプロバイダーに登録することで、テストできます。

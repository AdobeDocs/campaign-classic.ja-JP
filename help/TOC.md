...
+ はじめに {#getting-started}
  ...
  + {hide-from-toc}[Campaign エクスプローラーの使用 - 非表示](platform/using/adobe-campaign-explorer.md)
  ...
  + プロファイル管理 {#profile-management}
    ...
    + {hide-from-toc}[プロファイルの編集 - 非表示](platform/using/editing-a-profile.md)
    + {hide-from-toc}[プロファイルの追加 - 非表示](platform/using/adding-profiles.md)
    + {hide-from-toc}[プロファイルの管理 - 非表示](platform/using/managing-profiles.md)
    + [データ更新](platform/using/updating-data.md)
    + {hide-from-toc}[プロファイルのインポートとエクスポート - 非表示](platform/using/exporting-and-importing-profiles.md)
  ...
  + データのフィルタリング {#filtering-data}
    + {hide-from-toc}[フィルタリングオプション – 非表示](platform/using/filtering-options.md)
    + {hide-from-toc}[フィルターの作成 - 非表示](platform/using/creating-filters.md)
    + {hide-from-toc}[ユースケース - 非表示](platform/using/use-case.md)
  + {hide-from-toc}[クエリの作成手順 - 非表示](platform/using/steps-to-create-a-query.md)
  ...
  + 権限 {#permissions}
    ...
    + {hide-from-toc}[フォルダーへのアクセス管理 - 非表示](platform/using/access-management-folders.md)
  + CRM コネクタ {#connectors}
    + [CRM コネクタの基本を学ぶ](platform/using/crm-connectors.md)
    + {hide-from-toc}[Microsoft Dynamics 365 との接続](platform/using/crm-ms-dynamics.md)
    + {hide-from-toc}[Salesforce.com との接続](platform/using/crm-sfdc.md)
    + {hide-from-toc}[CRM とのデータの同期](platform/using/crm-data-sync.md)
  + {hide-from-toc}[ヘルプとサポートオプション - 非表示](support.md)
+ メッセージの作成と送信 {#sending-messages}
  ...
  + クイックスタート {#key-steps-when-creating-a-delivery}
    + {hide-from-toc}[配信の基本を学ぶ - 非表示](delivery/using/steps-about-delivery-creation-steps.md)
    + {hide-from-toc}[配信の作成と識別 - 非表示](delivery/using/steps-create-and-identify-the-delivery.md)
    + {hide-from-toc}[オーディエンスの定義 - 非表示](delivery/using/steps-defining-the-target-population.md)
    + {hide-from-toc}[配信の検証 - 非表示](delivery/using/steps-validating-the-delivery.md)
    + {hide-from-toc}[配信の送信 - 非表示](delivery/using/steps-sending-the-delivery.md)
  ...
  + 配信のベストプラクティス {#delivery-bestpractices}
    ...
    + {hide-from-toc}[テンプレートの使用 - 非表示](delivery/using/use-templates.md)
    ...
    + {hide-from-toc}[送信前の確認 - 非表示](delivery/using/check-before-sending.md)
  ...
  + メールの送信 {#sending-emails}
    ...
    + {hide-from-toc}[メールコンテンツの定義 - 非表示](delivery/using/defining-the-email-content.md)
    + {hide-from-toc}[インタラクティブコンテンツの定義 - 非表示](delivery/using/defining-interactive-content.md)
    + メール配信の送信 {#sending-an-email}
      + {hide-from-toc}[メールを送信する主な手順 - 非表示](delivery/using/sending-messages.md)
      + {hide-from-toc}[メールパラメーター - 非表示](delivery/using/email-parameters.md)
      + {hide-from-toc}[日本の携帯電話での送信 - 非表示](delivery/using/sending-emails-on-japanese-mobiles.md)
  ...
  + SMS の送信 {#sending-messages-on-mobiles}
    ...
    + {hide-from-toc}[SMS の作成 - 非表示](delivery/using/sms-create.md)
    + {hide-from-toc}[拡張された汎用 SMPP コネクタへの移行](delivery/using/unsupported-connector-migration.md)
  ...
  + プッシュ通知の送信 {#sending-push-notifications}
    + {hide-from-toc}[Campaign SDK のモバイルアプリケーションへの統合](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
    + モバイルアプリケーションの設定{#configure-the-mobile-app}
      + {hide-from-toc}[アプリ設定の基本を学ぶ - 非表示](delivery/using/get-started-app-config.md)
      + {hide-from-toc}[iOS の設定手順 - 非表示](delivery/using/configuring-the-mobile-application.md)
      + {hide-from-toc}[Android の設定手順 - 非表示](delivery/using/configuring-the-mobile-application-android.md)
    + プッシュ通知の作成{#create-a-push-msg}
      + {hide-from-toc}[iOS 用プッシュメッセージの作成 - 非表示](delivery/using/create-notifications-ios.md)
      + {hide-from-toc}[Android 用プッシュメッセージの作成 - 非表示](delivery/using/create-notifications-android.md)
  ...
  + ダイレクトメールの送信 {#sending-direct-mail}
    + {hide-from-toc}[ダイレクトメール配信の作成 - 非表示](delivery/using/creating-a-direct-mail-delivery.md)
  ...
  + 配信テンプレートの使用 {#using-delivery-templates}
    + {hide-from-toc}[配信テンプレートの操作 - 非表示](delivery/using/about-templates.md)
    + {hide-from-toc}[配信テンプレートの作成 - 非表示](delivery/using/creating-a-delivery-template.md)
    + {hide-from-toc}[ターゲットマッピングの選択 - 非表示](delivery/using/selecting-a-target-mapping.md)
    + {hide-from-toc}[テンプレートからの配信の作成 - 非表示](delivery/using/creating-a-delivery-from-a-template.md)
  + 配信のパーソナライズ {#personalizing-deliveries}
    ...
    + {hide-from-toc}[パーソナライズされた PDF ドキュメントの生成 - 非表示](delivery/using/generating-personalized-pdf-documents.md)
    + {hide-from-toc}[顔文字リストのカスタマイズ](delivery/using/customizing-emoticon-list.md)
...
+ マーケティングキャンペーンのオーケストレーション {#orchestrating-campaigns}
  ...
  + マーケティングキャンペーンについて {#about-marketing-campaigns}
    + {hide-from-toc}[マーケティングキャンペーンの設計 - 非表示](campaign/using/designing-marketing-campaigns.md)
  ...
  + キャンペーンのオーケストレーション {#orchestrate-campaigns}
    + {hide-from-toc}[マーケティングキャンペーンの基本を学ぶ - 非表示](campaign/using/setting-up-marketing-campaigns.md)
    + {hide-from-toc}[テンプレートの作成と設定 - 非表示](campaign/using/marketing-campaign-templates.md)
    + {hide-from-toc}[配信の追加 - 非表示](campaign/using/marketing-campaign-deliveries.md)
    + {hide-from-toc}[オーディエンスの選択 - 非表示](campaign/using/marketing-campaign-target.md)
  ...
  + キャンペーンの最適化 {#campaign-optimization}
    + {hide-from-toc}[キャンペーンタイポロジについて - 非表示](campaign-opt/using/about-campaign-typologies.md)
    + {hide-from-toc}[頻度ルール - 非表示](campaign-opt/using/pressure-rules.md)
    + {hide-from-toc}[一貫性ルール - 非表示](campaign-opt/using/consistency-rules.md)
    + {hide-from-toc}[コントロールルール - 非表示](campaign-opt/using/control-rules.md)
    + {hide-from-toc}[フィルタリングルール - 非表示](campaign-opt/using/filtering-rules.md)
...
+ マーケティングリソース管理 {#mrm}
  ...
  + {hide-from-toc}[コスト管理 - 非表示](mrm/using/controlling-costs.md)
...
+ 分散型マーケティング {#distributed-marketing}
  + {hide-from-toc}[分散型マーケティングについて - 非表示](distributed/using/about-distributed-marketing.md)
  + {hide-from-toc}[ローカルキャンペーンの作成 - 非表示](distributed/using/creating-a-local-campaign.md)
  + {hide-from-toc}[協調キャンペーンの作成 - 非表示](distributed/using/creating-a-collaborative-campaign.md)
  + {hide-from-toc}[キャンペーンパッケージの公開 - 非表示](distributed/using/publishing-the-campaign-package.md)
  + {hide-from-toc}[キャンペーンへのアクセス - 非表示](distributed/using/accessing-campaigns.md)
  + {hide-from-toc}[キャンペーンのトラッキング - 非表示](distributed/using/tracking-a-campaign.md)
...
+ ワークフローを使用した自動化 {#automating-with-workflows}
  + ワークフローの基本を学ぶ {#introduction}
    ...
    + {hide-from-toc}[ワークフローデータの使用 - 非表示](workflow/using/how-to-use-workflow-data.md)
    + {hide-from-toc}[ワークフローのベストプラクティス - 非表示](workflow/using/workflow-best-practices.md)
  + ワークフローの実行 {#executing-a-workflow}
    + {hide-from-toc}[ワークフローの開始 - 非表示](workflow/using/starting-a-workflow.md)
    + {hide-from-toc}[ワークフローのライフサイクル - 非表示](workflow/using/workflow-life-cycle.md)
    + {hide-from-toc}[データのライフサイクル - 非表示](workflow/using/data-life-cycle.md)
  ...
  + ターゲティングアクティビティ {#targeting-activities}
    + {hide-from-toc}[ターゲティングアクティビティについて - 非表示](workflow/using/about-targeting-activities.md)
    + {hide-from-toc}[クエリ - 非表示](workflow/using/query.md)
    + {hide-from-toc}[増分処理クエリ - 非表示](workflow/using/incremental-query.md)
    + {hide-from-toc}[リスト読み込み - 非表示](workflow/using/read-list.md)
    ...
    + {hide-from-toc}[オファー（セル別）- 非表示](workflow/using/offers-by-cell.md)
    + {hide-from-toc}[配信の概要 - 非表示](workflow/using/delivery-outline.md)
    + {hide-from-toc}[エンリッチメント - 非表示](workflow/using/enrichment.md)
    + {hide-from-toc}[スキーマの編集 - 非表示](workflow/using/edit-schema.md)
    + {hide-from-toc}[オファーエンジン - 非表示](workflow/using/offer-engine.md)
    + {hide-from-toc}[重複排除 - 重複 - 非表示](workflow/using/deduplication.md)
    + {hide-from-toc}[ディメンションを変更 - 非表示](workflow/using/change-dimension.md)
    + {hide-from-toc}[リストの更新 - 非表示](workflow/using/list-update.md)
    + {hide-from-toc}[購読サービス - 非表示](workflow/using/subscription-services.md)
  ...
  + フロー制御アクティビティ {#flow-control-activities}
    + {hide-from-toc}[フロー制御アクティビティについて - 非表示](workflow/using/about-flow-control-activities.md)
    + {hide-from-toc}[開始と終了 - 非表示](workflow/using/start-and-end.md)
    + {hide-from-toc}[分岐 - 非表示](workflow/using/fork.md)
    + {hide-from-toc}[AND 結合 - 非表示](workflow/using/and-join.md)
    ...
    + {hide-from-toc}[ジャンプ（開始ポイントと終了ポイント - 非表示）](workflow/using/jump-start-point-and-end-point.md)
  ...
  + アクションアクティビティ {#action-activities}
    ...
    + {hide-from-toc}[配信コントロール - 非表示](workflow/using/delivery-control.md)
    + {hide-from-toc}[連続配信 - 非表示](workflow/using/continuous-delivery.md)
    + {hide-from-toc}[繰り返し配信 - 非表示](workflow/using/recurring-delivery.md)
    + {hide-from-toc}[クロスチャネル配信 - 非表示](workflow/using/cross-channel-deliveries.md)
    + {hide-from-toc}[ローカルの承認 - 非表示](workflow/using/local-approval.md)
    ...
    + {hide-from-toc}[データ読み込み（ファイル）- 非表示](workflow/using/data-loading-file.md)
    ...
    + {hide-from-toc}[SQL コードと JavaScript コード - 非表示](workflow/using/sql-code-and-javascript-code.md)
    + {hide-from-toc}[SQL データ管理 - 非表示](workflow/using/sql-data-management.md)
    + {hide-from-toc}[Nlserver モジュール - 非表示](workflow/using/nlserver-module.md)
  ...
  + イベントアクティビティ {#event-activities}
    ...
    + {hide-from-toc}[ファイルの転送 - 非表示](workflow/using/file-transfer.md)
  ...
  + ユースケース {#use-cases}
    + {hide-from-toc}[ワークフローのユースケースについて - 非表示](workflow/using/about-workflow-use-cases.md)
    + 配信 {#deliveries}
      + {hide-from-toc}[ローカルの承認アクティビティの使用 - 非表示](workflow/using/using-the-local-approval-activity.md)
      ...
      + {hide-from-toc}[カスタム日付フィールドを使用したメールエンリッチメント - 非表示](workflow/using/email-enrichment-with-custom-date-fields.md)
  + 監視 {#monitoring}
    + {hide-from-toc}[リストへのレポートの送信 - 非表示](workflow/using/sending-a-report-to-a-list.md)
    + {hide-from-toc}[ワークフローの監視 - 非表示](workflow/using/supervising-workflows.md)
    + {hide-from-toc}[オペレーターへのパーソナライズされたアラートの送信 - 非表示](workflow/using/sending-personalized-alerts-to-operators.md)
  + データ管理 {#data-management}
    ...
    + {hide-from-toc}[集計の使用 - 非表示](workflow/using/using-aggregates.md)
    + {hide-from-toc}[重複の除外アクティビティの結合機能の使用 - 非表示](workflow/using/deduplication-merge.md)
    + {hide-from-toc}[繰り返しインポートワークフローの設定 - 非表示](workflow/using/recurring-import-workflow.md)
  + クエリの設計 {#designing-queries}
    + {hide-from-toc}[増分処理クエリを使用した四半期ごとのリストの更新 - 非表示](workflow/using/quarterly-list-update.md)
  + クエリとフィルター {#query-and-filter-hidden}
    + {hide-from-toc}[受信者テーブルのクエリ - 非表示](workflow/using/querying-recipient-table.md)
    + {hide-from-toc}[配信情報のクエリ - 非表示](workflow/using/querying-delivery-information.md)
    + {hide-from-toc}[集計計算の実行 - 非表示](workflow/using/performing-aggregate-computing.md)
    + {hide-from-toc}[グループ化管理を使用したクエリ - 非表示](workflow/using/querying-using-grouping-management.md)
    + {hide-from-toc}[多対多関係を使用したクエリ - 非表示](workflow/using/querying-using-many-to-many-relationship.md)
    + {hide-from-toc}[定義済みリストタイプ計算フィールドの追加 - 非表示](workflow/using/adding-enumeration-type-calculated-field.md)
    + {hide-from-toc}[フィルターの作成 - 非表示](workflow/using/creating-a-filter.md)
    + {hide-from-toc}[重複した受信者のフィルタリング - 非表示](workflow/using/filtering-duplicated-recipients.md)
  + ワークフローの監視 {#monitoring-workflows}
    ...
    + {hide-from-toc}[ワークフローヒートマップ - 非表示](workflow/using/heatmap.md)
  + 高度な管理 {#advanced-management}
    + {hide-from-toc}[ワークフローのプロパティ - 非表示](workflow/using/workflow-properties.md)
    + {hide-from-toc}[詳細設定パラメーター - 非表示](workflow/using/advanced-parameters.md)
    + {hide-from-toc}[JavaScript のスクリプトとテンプレート - 非表示](workflow/using/javascript-scripts-and-templates.md)
    + {hide-from-toc}[ワークフローでの JavaScript コードの例 - 非表示](workflow/using/javascript-in-workflows.md)
...
+ インストールおよび設定ガイド {#installing-campaign-classic}
  ...
  + Campaign の設定 {#additional-configurations}
    ...
    + {hide-from-toc}[Campaign での MX サーバーの使用](installation/using/using-mx-servers.md)
  ...
  + 付録 {#appendices}
    ...
    + {hide-from-toc}[Campaign のアンインストール](installation/using/uninstalling-campaign.md)
...
+ 移行ガイド {#migrating-to-a-new-version}
  + {hide-from-toc}[Adobe Campaign v7 に移行](migration/using/about-migration.md)
  + 移行手順 {#migration-procedure}
    ...
    + {hide-from-toc}[設定の適応](migration/using/configuring-your-platform.md)
...
+ テクニカルノート {#technotes}
  ...
  + アップグレードと互換性{#technote-migration}
    ...
    + {hide-from-toc}[新しい配信サーバー](technotes/using/deliverability-server.md)
  ...
  + メールとプッシュ通知{#technotes-email}
    ...
    + {hide-from-toc}[ISP の機能停止後の誤ったハードバウンスの更新](delivery/using/update-bounces.md)
    + [iOS 証明書の更新](technotes/using/ios-certificate-update.md)
    + {hide-from-toc}[トラッキング対象 URL の更新](technotes/using/tracked-urls.md)

...
調査テンプレートを選択し、調査に名前を付けます。この名前は、エンドユーザーには表示されませんが、Adobe Campaign内で調査を識別することができます。 「**[!UICONTROL 保存]**」をクリックして、調査を Web アプリケーションのリストに追加します。
...
次の例では、 **[!UICONTROL ページ（v5 互換）]** ページを入力します。 このタイプのページは、「**[!UICONTROL 編集]**」タブの詳細設定メニューからアクセスします。

![](assets/s_ncs_admin_survey_pagev5.png)

* **入力フィールドの追加**

  ページのコンテンツを作成するには、編集する必要があります。編集するには、 **[!UICONTROL ページ]** オブジェクト。ツールバーの最初のアイコンをクリックして、フィールド作成ウィザードを開きます。 （受信者のプロファイルの一致するフィールドに格納される）ユーザー名の入力フィールドを作成するには、「**[!UICONTROL 受信者を編集]**」を選択します。
...
* **質問の作成**
  ...
  質問のラベルを入力し、質問のサブ分岐として回答フィールドを挿入します。これをおこなうには、回答フィールドを作成する際に、質問にリンクされたノードを選択する必要があります。 **[!UICONTROL 選択コントロール]**&#x200B;アイコンまたは次に示すように右クリックで、**[!UICONTROL ドロップダウンリスト]**&#x200B;を追加します。
  ...
  >[!NOTE]
  >
  >各フィールドまたは質問で、 **[!UICONTROL 詳細]** タブをクリックします。 調査画面のレイアウトについて詳しくは、[この節](../../web/using/about-web-forms.md)を参照してください。

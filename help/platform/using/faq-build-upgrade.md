...
いいえ。Adobeでは、データの欠落や損失を避けるために、メンテナンス期間中はキャンペーンの操作を無効にすることをお勧めします。 アップグレード中に、キャンペーン、クエリ、ワークフロー、配信を作成またはデプロイしないでください。
...
いいえ。ビルドのアップグレード中には、ワークフローとメールサービスの両方が停止します。これは、ワークフローが実行されず、配信が送信されないことを意味します。システムが再起動されると、再開されます。ただし、Adobeでは、アップグレード後にすべてのクリティカルパスワークフローをチェックして、ワークフローが正常に動作していることを確認することを強くお勧めします。

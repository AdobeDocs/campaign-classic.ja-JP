...
* **[!UICONTROL 協調キャンペーン（フォーム）]**：最大 300 までのローカルエンティティが参加するキャンペーンに最適です。ローカルエンティティは、Webフォームでターゲット設定とコンテンツのパーソナライゼーションのための定義済みパラメーターを入力できます。 Web フォームは、Adobe Campaign のフォームまたは外部のフォーム（エクストラネットのクライアント）のいずれかです。機能管理者は、インテグレーターによって定義されたフォームテンプレートに基づいて、フォームを定義および設定できます。キャンペーンを注文するには、ローカルエンティティにWebアクセスが必要です。
...
* **[!UICONTROL 協調キャンペーン（ターゲットの承認）]**：数千のローカルエンティティが参加するキャンペーンに最適です。ローカルエンティティは、セントラルエンティティによってあらかじめ定義された連絡先リストを受け取り、ローカルエンティティは、キャンペーンのコンテンツに基づいて特定の連絡先をWebフォームで保持するかどうかを決定します。 ローカルエンティティは、選択した連絡先リストの中から選ばれます。キャンペーンに参加するには、ローカルエンティティはWebアクセスのみが必要です。
...
1. ローカライゼーションパラメーターの表示、ターゲットと予算の評価、コンテンツのプレビュー、注文の承認を行うことができるWebフォーム(Adobeまたはエクストラネット)を作成します。

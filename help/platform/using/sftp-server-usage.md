...
* SFTP接続を開始しようとするパブリックIPは、キャンペーンインスタンスの許可リストに追加する必要があります。 Adding IP addresses to the allowlist can be requested via a [support ticket](https://support.neolane.net).

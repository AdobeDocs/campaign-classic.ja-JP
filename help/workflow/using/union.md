...
>[!NOTE]
>
>ユニオンアクティビティの設定と使用について詳しくは、複数のターゲ [ットの組み合わせ(Union)を参照してくださ](../../workflow/using/targeting-data.md#combining-several-targets--union-)い。
...
1. 最終的な母集団のサイズを制限する場合は、このボックスをオンにし **[!UICONTROL Limit size of generated population]** ます。

...
Campaign v7.4以降、Campaign SDKは[非推奨](deprecated-features.md)です。 既存の実装をAEP Mobile SDKにスムーズに移行するには、以下のオペレーティングシステムで引き続き使用できます。<!--, using the associated [mobile SDK](../../delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)-->。

...
* インスタンスのアクティビティの監視
* 検証プロセスに参加します（例えば、配信コンテンツの承認または却下）。
* ワークフローの一時停止など、その他のクイックアクションを実行する
* すべてのレポート機能にアクセス
* フォーラムディスカッションに参加する
...
| キャンペーン | キャンペーンのキャンセル |
| 配信 | 配信コンテンツとターゲットの承認<br/>配信コンテンツを送信<br/>配信の確認<br/>配信の一時停止と停止 |
| Web アプリケーション | Web アプリケーションの作成<br/>アプリケーションのコンテンツとプロパティを編集します<br/>アプリケーションコンテンツをテンプレートとして保存<br/>アプリを公開 |
| オファー | オファーのコンテンツと実施要件を承認<br/>オンラインオファーを無効にする |
| タスク | タスクを完了<br/>タスクのキャンセル |
...
| フォーラム | ディスカッションを追加<br/>ディスカッション内のメッセージに返信する<br/>ディスカッションをフォローし、購読を解除する |

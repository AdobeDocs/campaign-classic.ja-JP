...
すべてのタスクは、**キャンペーン**&#x200B;ウィンドウからアクセスできるリストにグループ化されます。詳しくは、[タスクへのアクセス](#accessing-tasks)を参照してください。
...
タスクは、**[!UICONTROL キャンペーン]**&#x200B;ウィンドウのタスクリストに表示されます。
...
タスクを作成するには、キャンペーンウィンドウで「**[!UICONTROL タスク]**」リンクをクリックし、「**[!UICONTROL 作成]**」を選択します。
...
* **[!UICONTROL コントロールタスク]**（[コントロールタスク](#control-tasks)を参照）
* **[!UICONTROL マーケティングリソース作成タスク]**（[グループ化タスク](#grouping-task)を参照）
* **[!UICONTROL グループ化タスク]**（[グループ化タスク](#grouping-task)を参照）
* **[!UICONTROL 通知タスク]**（[通知タスク](#notification-task)を参照）

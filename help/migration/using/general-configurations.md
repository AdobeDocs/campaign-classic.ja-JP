...
-->
新しいレポート機能を活用したい場合は、レポートを再公開する必要があります。 この場合は、すべてのスクリプトを確認し、必要に応じて変更します。 PDFのエクスポートに関して、Open Office 用の特定のスクリプトを追加した場合、新しいPDFエクスポートエンジン (PhantomJS) では動作しなくなります。

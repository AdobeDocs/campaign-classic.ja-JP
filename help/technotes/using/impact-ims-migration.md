...
オペレーターの管理は Adobe Admin Console に一元化されて、次のタスクはこのコンソールを通じてのみ管理されるようになりました。 ユーザーを作成し、権限を割り当てる方法について詳しくは、[Campaign v8 ドキュメント](https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/admin/permissions/manage-permissions){target="_blank"}を参照してください。

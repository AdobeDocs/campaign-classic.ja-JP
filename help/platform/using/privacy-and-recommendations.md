...
* **Anne** は航空会社の&#x200B;**データ管理者**&#x200B;です。Laura の要求を受け取り、データ主体を識別するために要求された有用な ID を取得して、要求をAdobe Campaignに送信します。

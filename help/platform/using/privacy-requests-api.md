...
1. URL **`<server url>`/nl/jsp/schemawsdl.jsp?schema=xtk:session** 経由で **xtk:session** WSDL をダウンロードします。
...
1. URL **`<server url>`/nl/jsp/schemawsdl.jsp?schema=nms:privacyRequest** から WSDL をダウンロードします。

...
---
# プロンプト 1: Vue d&#39;Ensemble - Tous les Folders v7
...
2. **カーソルに貼り付け**
3. **分析の実行**
4. **完全な Markdown レポートを取得**
5. **名前を付けて保存**: `v7-reorganization-overview.md`

&#x200B;---

## 出力プレビュー

このレポートは、以下を含む 21 のすべてのフォルダーに適用される詳細な Markdown のページを約 50～60 ページにわたって提供します。
- エグゼクティブサマリー
- フォルダー分析
- 優先順位付け
- アクション アイテム

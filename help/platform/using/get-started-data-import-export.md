...
>[!NOTE]
>
>Campaign へのデータのインポートおよびエクスポート方法について詳しくは、[Campaign v8 ドキュメント](https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/data/import){target=_blank}を参照してください。

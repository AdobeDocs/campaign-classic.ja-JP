...
|--- |--- |
| Adobe Campaign ユーザーがコントロールインスタンスにログオンすると、次の操作が可能になります。 <ul><li>トランザクションメッセージテンプレートの作成</li><li>シードリストを使用したメッセージプレビューの生成</li><li>レポートを表示</li><li>実行インスタンスの監視</li></ul> | 実行インスタンスは次の目的で使用します。 <ul><li>イベントの受信</li><li>トランザクションメッセージテンプレートへのイベントのリンク</li><li>各受信者へのパーソナライズされたメッセージの送信</li></ul> |

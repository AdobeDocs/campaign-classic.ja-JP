...
* **例：?** アカウント作成後のウェルカムメッセージ、注文の発送確認、請求書、パスワード変更の確認メッセージ、顧客がweb サイトを閲覧した後の通知、製品の在庫状況に関するコミュニケーション、アカウントに関する声明など、さまざまな種類のメッセージが考えられます。
...
* [配信の作成の主な手順](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html?lang=ja){target="_blank"}

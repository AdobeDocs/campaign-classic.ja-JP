...
>[!NOTE]
>
>Adobe Campaign のプライバシーと安全に関する規制について詳しくは、[Campaign v8 ドキュメント](https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/privacy/security){target=_blank}を参照してください。
